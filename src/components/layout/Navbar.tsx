    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/80 backdrop-blur-md dark:bg-gray-950/80 dark:border-gray-800">
      <div className="mx-auto flex h-16 max-w-7xl items-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4 xl:ml-8 lg:ml-8 md:ml-8 ml-auto w-full md:w-auto">
          <form action="/search" method="GET" className="relative group w-full md:w-auto flex items-center">
            <input type="text" name="q" placeholder="Search products..." required className="w-full md:w-64 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-sm rounded-full pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all dark:text-white" />
            <button type="submit" aria-label="Submit Search" className="absolute left-2.5 top-1/2 -translate-y-1/2 p-1 text-gray-400 hover:text-blue-500 focus:text-blue-500 transition-colors disabled:opacity-50 z-10 cursor-pointer">
