            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {['Ninja', 'Vitamix', 'NutriBullet', 'Hamilton Beach', 'Samsung', 'LG'].map((brand) => (
                    <label key={brand} className="flex items-center gap-3 cursor-pointer group">
                      <div className="relative flex items-center justify-center">
                        <input type="checkbox" className="peer appearance-none w-5 h-5 border border-gray-300 rounded checked:bg-blue-600 checked:border-blue-600 dark:border-gray-600 dark:bg-gray-800 transition-colors cursor-pointer" />
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input type="number" placeholder="Min" className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:bg-gray-950 dark:border-gray-800 dark:text-white transition-all" />
                  <span className="text-gray-400">-</span>
                  <input type="number" placeholder="Max" className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:bg-gray-950 dark:border-gray-800 dark:text-white transition-all" />
                </div>
              </div>
            </div>
          </div>
